            ...
            <div className='sm:flex sm:justify-between px-3 sm:px-0'>
                ...
                <div className="sm:mr-5">
                    ...
                    <div className="sm:flex sm:w-40 w-24 mx-auto sm:mx-0">
                        <Link href="https://play.google.com/"><Image src={Play}/></Link>
                        <Link href="https://www.apple.com/app-store/"><Image src={Store}/></Link>
                    </div>
                    ...
                    <div className='flex justify-around sm:justify-normal w-28 gap-2 mx-auto sm:mx-0'>
                        <Link href="https://facebook.com/"><Image src={Face} /></Link>
                        <Link href="https://pinterest.com/"><Image src={Pinte}/></Link>
                        <Link href="https://instagram.com/"><Image src={Insta}/></Link>
                    </div>
                </div>
            </div>
